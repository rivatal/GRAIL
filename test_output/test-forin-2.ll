...
matching x with type: strassigning x to strupdating map func for  (call print((x: str))) : void; 
matching x with type: strupdating map func for for ((x: str) in (a: list of str)){ (call print((x: str))) : void; 

updating map func for  (call print((x: str))) : void; 
...
@str5 = private unnamed_addr constant [2 x i8] c"c\00"
...
entry:
  ...
  store i8* getelementptr inbounds ([2 x i8]* @str4, i32 0, i32 0), i8** %ptr1
  %ptr2 = getelementptr inbounds i8** %lst, i32 2
  store i8* getelementptr inbounds ([2 x i8]* @str5, i32 0, i32 0), i8** %ptr2
