...
entry:
  ...
  %ptr11 = getelementptr inbounds { { i32, i32 }*, { i32, i32 }*, i1, { i32 } }* %e10, i32 0, i32 1
  %to = load { i32, i32 }** %ptr11
  %to12 = load { i32, i32 }* %to
  %z = alloca { i32, i32 }
  store { i32, i32 } %to12, { i32, i32 }* %z
  %ext_val = getelementptr inbounds { i32, i32 }* %z, i32 0, i32 0
  %8 = load i32* %ext_val
  %printf = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt4, i32 0, i32 0), i32 %8)
  ret i32 0
}
