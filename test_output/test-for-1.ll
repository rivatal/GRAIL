...
while_body:                                       ; preds = %while
  %i1 = load i32* %i
  %printf = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt8, i32 0, i32 0), i32 %i1)
  %i2 = load i32* %i
  %tmp = add i32 %i2, 1
  store i32 %tmp, i32* %i
  br label %while
...
merge:                                            ; preds = %while
  %printf5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt8, i32 0, i32 0), i32 42)
  ret i32 0
}
