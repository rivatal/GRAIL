...
@str2 = private unnamed_addr constant [5 x i8] c"bird\00"
@str3 = private unnamed_addr constant [4 x i8] c"dog\00"
@str4 = private unnamed_addr constant [4 x i8] c"dog\00"
...
entry:
  ...
  store i8* getelementptr inbounds ([5 x i8]* @str2, i32 0, i32 0), i8** %ptr1
...
merge:                                            ; preds = %checklimits
  ...
  store i8* getelementptr inbounds ([4 x i8]* @str3, i32 0, i32 0), i8** %ptr21
  ...
  store i8* getelementptr inbounds ([4 x i8]* @str4, i32 0, i32 0), i8** %ptr30
