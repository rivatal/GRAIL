...
matching x with type: strassigning x to strupdating map func for  (call print((x[(0: int)] : str))) : void; 
matching x with type: strupdating map func for (y: list of str) = (x: list of str); 
updating map func for (y[(0: int)] : str) = (dog: str); 
matching x with type: strassigning x to strupdating map func for  (call print((x[(0: int)] : str))) : void; 
matching x with type: strupdating map func for (z: list of str) = (x: list of str); 
updating map func for (z[(0: int)] : str) = (dog: str); 
matching x with type: strassigning x to strupdating map func for  (call print((x[(0: int)] : str))) : void; 
...
@str8 = private unnamed_addr constant [5 x i8] c"bird\00"
@str9 = private unnamed_addr constant [4 x i8] c"dog\00"
@str10 = private unnamed_addr constant [4 x i8] c"dog\00"
...
entry:
  ...
  store i8* getelementptr inbounds ([5 x i8]* @str8, i32 0, i32 0), i8** %ptr1
...
merge:                                            ; preds = %checklimits
  ...
  store i8* getelementptr inbounds ([4 x i8]* @str9, i32 0, i32 0), i8** %ptr21
  ...
  store i8* getelementptr inbounds ([4 x i8]* @str10, i32 0, i32 0), i8** %ptr30
