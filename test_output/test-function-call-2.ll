...
matching x with type: strmatching x with type: strassigning x to strupdating map func for  (call print((IN F: str))) : void; 
matching x with type: strupdating map func for  (call f()) : void; 
matching x with type: strassigning x to strupdating map func for  (call print((MAIN: str))) : void; 
