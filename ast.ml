...
(*   | Rfun of id * expr list * stmt list This is a dummy type for function calls
 *)  | Noexpr
...
(*   | Arfun of id * expr list * stmt list * primitiveType (*This is a dummy type for function calls*)
 *)
